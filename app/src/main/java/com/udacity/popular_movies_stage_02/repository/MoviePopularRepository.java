...
public class MoviePopularRepository {
    ...
    @Inject
    public MoviePopularRepository(MovieService movieService, AppExecutors appExecutors) {
    ...
    public MutableLiveData<Resource<MovieResponse>> getMovies(final int page) {
        ...
        mAppExecutors.getmNetworkIo().execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    Movies originalMovies = mMovieService.listMovieByPopularity(page).execute().body();
